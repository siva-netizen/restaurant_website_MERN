...
const Orders = () => {
    ...
    const handleCompletedOrders = () => {
        navigate('/completed-orders'); // Navigate to the "Completed Orders" page
    };
        ...
        <div className="container mx-auto w-3/4">
            <div className="mt-20">
                <div className="flex justify-center">
                    <button onClick={handleCompletedOrders}
                    className=" px-4 py-2 mb-8 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
